...
exec /bin/zsh "$ROOT/scripts/launch-macos.zsh"
`);
...
rmSync(iconset,{recursive:true,force:true});console.log(`Created ${app}. Double-click it to launch MyAvatar. Launcher fixes now come from scripts/launch-macos.zsh without requiring another app rebuild.`);
