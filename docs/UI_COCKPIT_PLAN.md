...
- Compact-column anchor handling; default 260 x 370 and chat-only 260 x 570 retained. Larger stacks request bounded additional height.
...
- Original artwork, avatar renderer, speech providers, prompts and `src/app/widget-runtime.js` were unchanged by these UI passes.
...
- `src/app/entry.js`: existing application followed by widget/polish CSS and panel controller.
...
- `src/styles/widget-cockpit.css`, `src/styles/widget-panels.css`, `src/styles/widget-polish.css`: presentation, stack and wing layout.
