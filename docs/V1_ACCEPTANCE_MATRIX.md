...
| Voice turn loop | Repeated turns, endpointing, deliberate cancellation, noise-safe reply playback, bot-specific TTS, restart, automatic launch listening, and greeting | Voice integration and soak tests | Implementation complete; synthetic fixtures and native smoke pass, real-microphone Hinglish and repeated-turn soak pending |
