...
Keep changes small, local-first, and easy to validate. Read the [MVP planning index](mvp/README.md) before changing product behavior.
...
6. Update the MVP docs when scope, acceptance, or UI behavior changes.

## Pull requests

Describe the user-visible change, the MVP contract it supports, and validation performed. Preserve the five approved companion identities and avoid third-party character likenesses or logos.
