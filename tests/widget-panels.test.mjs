...
const {widgetLayout,validPanelsRequest}=layoutAPI;
...
test('compact dimensions are unchanged',()=>assert.deepEqual(widgetLayout({x:1170,y:100},{},area).bounds,{x:1170,y:100,width:260,height:338}));
...
test('closing a large stack restores the original anchor',()=>{
  ...
  assert.deepEqual(widgetLayout(anchor,{},area).bounds,{...anchor,width:260,height:338});
});
...
test('all tested layouts stay within work area bounds',()=>{
  for(const width of [260,400,600,800,1440])for(const height of [338,480,600,900]){
